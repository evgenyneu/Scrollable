...
1. Add Auto Layout constraints for all the content views. The trick is to make sure **all four sides of the scroll view** have layout constraints to the content views. This will make the scroll view content expand based on the size of the content views.
